  ...
  return (
    <View style={styles.pubContainer}>
      <View style={styles.pubTitle}>
        ...
        <TouchableHighlight
          style={styles.pubLogout}
          onPress={() => alert("Press on Out")}
        >
